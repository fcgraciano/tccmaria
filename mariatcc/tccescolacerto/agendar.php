...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['data'], $_POST['hora'], $_POST['servico'], $_POST['pagamento'])) {
    ...
    session_destroy();
    header("Location: login.php?msg=agendado");
    exit;
}
?>
...
.container { max-width:700px; background:#fff; border-radius:12px; padding:25px; margin-top:40px; box-shadow:0 4px 10px rgba(0,0,0,0.1); }
